        ...
        if (successful) {
           [self dismiss];
            UIAlertView *alert = [[UIAlertView alloc]
                                  ...
                                  message:NSLocalizedString(@"Your Fence(s) have been imported and can be found in the open menu.", @"A message informing the user that their Fences have been exported.")
                                  delegate:nil
